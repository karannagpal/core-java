 ...
 * @author HP
 */
public class UpdateEmpById extends javax.swing.JFrame {

    /**
     * Creates new form UpdateEmpById
     */
    public UpdateEmpById()
    {
        initComponents();
    ...
    {//GEN-HEADEREND:event_button3ActionPerformed
        ...
        {
            int id;
            id = Integer.parseInt(t2.getSelectedItem());
            ...
            myConnection obj = new myConnection();
            String q = "update tbemployee set fname=?, lname=?, email=?, contact=?, address=? where id=?";
            PreparedStatement pst = obj.db.prepareStatement(q);
        ...
        {
            System.out.println("Error in button3");
            System.out.println(e.getMessage());
        }
    ...
    {//GEN-HEADEREND:event_button2ActionPerformed
        ...
        try
        {
            ...
            myConnection obj1 = new myConnection();
            String q1 = "select * from tbemployee where id=?";
            PreparedStatement pst = obj1.db.prepareStatement(q1);
        ...
        {
            System.out.println("Error in button2");
            System.out.println(e.getMessage());
        }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(UpdateEmpById.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run()
            {
                new UpdateEmpById().setVisible(true);
            }
        });
    }
